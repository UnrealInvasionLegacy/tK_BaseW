...
// Assault Rifle
//=============================================================================
class tK_AssaultRifle extends tK_Weapon;
...
{
    bFireLeft = false;
    tK_AssaultGrenade(FireMode[1]).ReturnToIdle();
...
{
    return FMin(1,FireMode[1].HoldTime/tK_AssaultGrenade(FireMode[1]).mHoldClampMax);
}
...
defaultproperties
{
     FireModeClass(0)=Class'tK_AssaultFire'
     FireModeClass(1)=Class'tK_AssaultGrenade'
     PutDownAnim="PutDown"
