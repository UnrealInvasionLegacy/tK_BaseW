...
// Minigun
//=============================================================================
class tK_Minigun extends tK_Weapon;
...
simulated function bool StartFire(int mode)
{
    ...
    if ( !tK_MinigunFire(FireMode[0]).IsIdle() || !tK_MinigunFire(FireMode[1]).IsIdle() )
        return false;
...
defaultproperties
{
     ...
     GearRatio=-2.370000
     Blend=1.000000
     FireModeClass(0)=Class'tK_MinigunFire'
     FireModeClass(1)=Class'tK_MinigunAltFire'
     PutDownAnim="PutDown"
