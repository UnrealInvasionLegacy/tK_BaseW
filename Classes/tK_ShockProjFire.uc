class tK_ShockProjFire extends tK_ProjectileFire;
...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
    ...
    if ( (tK_ShockRifle(Instigator.Weapon) != None) && (p != None) )
        tK_ShockRifle(Instigator.Weapon).SetComboTarget(tK_ShockProjectile(P));
    return p;
}
