...
class tK_AVRiL extends tK_Weapon;
...
{
    if (!FireMode[1].bIsFiring || tK_AVRiLAltFire(FireMode[1]) == None)
    {
        if (bLockedOn)
        {
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'tK_AVRiLFire'
     FireModeClass(1)=Class'tK_AVRiLAltFire'
     PutDownAnim="PutDown"
