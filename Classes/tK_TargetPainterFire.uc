class tK_TargetPainterFire extends tK_PainterFire;
    ...
    Aim = AdjustAim(StartTrace, AimError);
        ...
        if (Other != None && Other != Instigator)
        {
            ...
            Instigator.MakeNoise(3.0);
                        ...
                        {
                bValidMark = tK_TargetPainter(Weapon).CanBomb(HitLocation, BomberClass.default.CollisionRadius);
                ...
                if (bValidMark)
                {
                    ...
                    Instigator.PendingWeapon = None;
                                    tK_TargetPainter(Weapon).ReallyConsumeAmmo(ThisModeNum, 1);
        ...
        tK_TargetPainter(Weapon).EndEffect = EndEffect;
