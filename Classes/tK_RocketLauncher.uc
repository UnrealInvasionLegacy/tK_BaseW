...
// RocketLaucher
//=============================================================================
class tK_RocketLauncher extends tK_Weapon;
...
simulated event ClientStartFire(int Mode)
{
    ...
    if ( tK_RocketMultiFire(FireMode[Mode]) != None )
    {
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'tK_RocketFire'
     FireModeClass(1)=Class'tK_RocketMultiFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
