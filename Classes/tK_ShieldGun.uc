...
// Shield Gun
//=============================================================================
class tK_ShieldGun extends tK_Weapon;
...
function float GetAIRating()
{
    ...
    if ( (EnemyDist < 750) && (B.Skill <= 2) && !B.Enemy.IsA('Bot') && (tK_ShieldGun(B.Enemy.Weapon) != None) )
...
function DoReflectEffect(int Drain)
{
    ...
    tK_ShieldAltFire(FireMode[1]).TakeHit(Drain);
    ClientTakeHit(Drain);
}
...
{
    return FMin(1,FireMode[0].HoldTime/tK_ShieldFire(FireMode[0]).FullyChargedTime);
}
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'tK_ShieldFire'
     FireModeClass(1)=Class'tK_ShieldAltFire'
     PutDownAnim="PutDown"
