...
//
//-----------------------------------------------------------
class tK_GrenadeLauncher extends tK_Weapon;

#EXEC OBJ LOAD FILE=HudContent.utx

var array<tK_GrenadeProjectile> Grenades;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'tK_GrenadeFire'
     FireModeClass(1)=Class'tK_GrenadeAltFire'
     PutDownAnim="PutDown"
