class tK_AssaultGrenade extends tK_ProjectileFire;
...
function DoFireEffect()
{
    ...
    if ( tK_AssaultRifle(Weapon).bDualMode )
    {
        tK_AssaultRifle(Weapon).bFireLeft = !tK_AssaultRifle(Weapon).bFireLeft;
        if ( tK_AssaultRifle(Weapon).bFireLeft )
            Y *= -1;
    }
