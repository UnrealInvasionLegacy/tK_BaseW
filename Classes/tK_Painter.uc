class tK_Painter extends tK_Weapon;
...
simulated event RenderOverlays( Canvas Canvas )
{
    ...
    local tK_PainterFire PainterFire;
    ...
    {
        PainterFire = tK_PainterFire(FireMode[0]);
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'tK_PainterFire'
     FireModeClass(1)=Class'tK_PainterZoom'
     PutDownAnim="PutDown"
